...
-- CreateIndex
CREATE UNIQUE INDEX "users_role_id_key" ON "users_role"("id");

-- AddForeignKey
ALTER TABLE "admin" ADD CONSTRAINT "admin_role_id_fkey" FOREIGN KEY ("role_id") REFERENCES "users_role"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
